...
| 2026-08-10 | Shatior#2 | n/a | 3 | comportamiento + configuración + documentación | ~14 min (presupuesto acotado: 10 min / 30 mutaciones; **excedido en tiempo**, declarado en el acta; 19 mutaciones ejecutadas, 16 muertas) | 0 | 5 | 4 | 1, 3, 4, 7, 9, 10, 11 |
...
[`docs/revisiones/sitio--pasada-3.md`](revisiones/sitio--pasada-3.md).
